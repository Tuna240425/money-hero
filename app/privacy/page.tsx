...
const privacySections = [
  {
    ...
    title: "개인정보 처리방침 개요",
    icon: Shield,
    content: `임앤리 법률사무소(이하 "회사")은 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 등 관련 법령에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
...
• 연락처: moneyhero.service@gmail.com 
...
• 직책: 개인정보보호 책임자
• 연락처: 0507-1399-9302
• 이메일: moneyhero.service@gmail.com
